...
export default function Compare({ route, navigation }) {
    ...
    const getComparison = async () => {
        ...
        fetch(global.url + '/summarized_player_comparison/' + player1.cricmetric + '/' + player2.cricmetric)
            .then((res) => {
    ...
    const getHeadtoHead = async () => {
        ...
        fetch(global.url + '/summarized-head-to-head/' + player1.cricmetric + '/' + player2.cricmetric)
            .then((res) => {
    ...
    if (check == false) {
        ...
        else if (player1.role == "Bowler" || player2.role == "Bowler") {
            getHeadtoHead()
        }
        else {
            getComparison()
    ...
    } else if ((player1.role == player2.role)|| !(player1.role == "Bowler" || player2.role == "Bowler")) {
        return (
    ...
    } else if (compStats["total_matches"] == 0) {
        return (
            <View style={styles.container}>
                <ImageBackground source={require('../assets/stadium.jpg')} resizeMode="cover" style={styles.image}>
                    <Text style={styles.text}>Never came face to face</Text>
                </ImageBackground>
            </View>
        )
    } else {
