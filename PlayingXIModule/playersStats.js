...
export default function PlayerStats({ route, navigation }) {
  ...
  const getPlayer = async () => {
    ...
    fetch(global.url + '/get_player_summary/' + player.cricmetric)
      .then((res) => {
      ...
      <View style={styles.container}>
        <ImageBackground source={require('../assets/stadium.jpg')} resizeMode="cover" style={styles.image}>
          ...
          <View style={{ flex: 1, flexDirection: 'row', justifyContent: "space-around", }}>
            ...
            <View style={{ backgroundColor: '#000000c0', padding: 20, alignItem: "space-between", borderRadius: 15, maxHeight: 180 }}>
    ...
    return (
      <View style={styles.container}>
        <ImageBackground source={require('../assets/stadium.jpg')} resizeMode="cover" style={styles.image}>
          ...
          {/* <View style={{ flex: 1 }}>
            <Text style={styles.text3}>Bowling</Text>

          </View> */}
          <Text style={styles.text3}>Bowling Stats</Text>
          ...
          <Text style={styles.text3}>Batting Stats</Text>
          <View style={{ flex: 3, flexDirection: 'row', justifyContent: "space-around" }}>
